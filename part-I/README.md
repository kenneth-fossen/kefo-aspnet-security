...
We will follow Duende's Quickstart Guides for up to 4 experiences to familiarise yourself with ASP.NET WebAPI Security is working.
...
This server is hosting all the Identities, Scopes, AccessGroups and so forth. 
...
Empty client for Task 2, goal is to implement this and experiment with it.
